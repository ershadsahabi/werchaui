      ...
      <div className={`${styles.inner} container`}>
        ...
        <Link href="/" className={styles.logo} aria-label="خانه ورچه">
          <Image
            ...
            alt="" // alt خالی چون لینک دارای aria-label است
            width={44}
            height={44}
            priority
        ...
        {/* سرچ دسکتاپ */}
        {/* توجه: کانتینر استایل همان .search خود Header.module.css است،
            و خود ورودی/دکمه را از طریق props به SearchBox پاس می‌دهیم تا استایل‌ها هم‌خوان بماند */}
        <div className={styles.search} role="search" aria-label="جستجو در فروشگاه" dir="rtl">
          <SearchBox
            id="hdr-desktop"
            className=""                      // ظرف داخلی SearchBox
      ...
      >
        <div className="container">
          ...
          <div className={styles.mobileTop}>
            {/* سرچ موبایل: همان کامپوننت، با بستن منو پس از سابمیت/انتخاب */}
...
const iconCart = (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
    ...
    <path d="M3 4h3l1.5 9.5a2 2 0 0 0 2 1.5h8a2 2 0 0 0 1.9-1.3l2.1-6.7H7"
          stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
